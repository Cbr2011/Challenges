package net.mcreator.cbrmodschallenges.client.model;
...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("cbrmods_challenges", "modelcustom_model"), "main");
